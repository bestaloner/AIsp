...
add_para('【📊 插入图 1：整体工作路径图 — 文件 diagrams/01_整体工作路径图.drawio】', bold=True, size=Pt(10), color=RGBColor(0xF5,0x7A,0x00))
add_para(
...
add_para('【📊 插入图 2：证据链输出流程图 — 文件 diagrams/02_证据链输出流程图.drawio】', bold=True, size=Pt(10), color=RGBColor(0xF5,0x7A,0x00))
add_para(
...
add_para('【📊 插入图 3：标注与微调技术流程图 — 文件 diagrams/03_标注与微调技术流程图.drawio】', bold=True, size=Pt(10), color=RGBColor(0xF5,0x7A,0x00))
add_para(
...
add_para('【📊 插入图 4：协作角色图 — 文件 diagrams/04_协作角色图.drawio】', bold=True, size=Pt(10), color=RGBColor(0xF5,0x7A,0x00))
add_para(
...
# ── Save ──────────────────────────────────────────────
output_path = r'f:\0.AI设计库\ai视频识别\现版本设计文件\AI隐患识别模型调优方案_V2.1.docx'
